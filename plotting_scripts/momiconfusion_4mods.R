...
momiconf=read.csv(file="inferences/momi_nomaf_data_4mods_exp_deltaAIC.csv",head=TRUE)
...
momiconf %>%
  ...
  theme(axis.text.x = element_text(angle = 15))+
  facet_wrap(~sampn)
ggsave("plots/momi_confusion_wgs10k_exp_4mods.pdf",device="pdf")
...
momiconf %>%
  ...
  theme(axis.text.x = element_text(angle = 15))+
  facet_wrap(~sampn)
ggsave("plots/momi_confusion_rad10k10k_exp_4mods.pdf",device="pdf")
...
momiconf %>%
  ...
  theme(axis.text.x = element_text(angle = 15))+
  facet_wrap(~sampn)
ggsave("plots/momi_confusion_wgs10k_bot_4mods.pdf",device="pdf")
...
momiconf %>%
  ...
  theme(axis.text.x = element_text(angle = 15))+
  facet_wrap(~sampn)
ggsave("plots/momi_confusion_rad10k10k_bot_4mods.pdf",device="pdf")

...
momiconf=read.csv(file="inferences/momi_nomaf_data_exp_all_deltaAIC.csv",head=TRUE)
...
momiconf %>%
  ...
  theme(axis.text.x = element_text(angle = 15))+
  facet_wrap(~sampn)
ggsave("plots/momi_confusion_wgs10k_exp.pdf",device="pdf")
...
momiconf %>%
  ...
  theme(axis.text.x = element_text(angle = 15))+
  facet_wrap(~sampn)
ggsave("plots/momi_confusion_rad10k10k_exp.pdf",device="pdf")
...
momiconf %>%
  ...
  theme(axis.text.x = element_text(angle = 15))+
  facet_wrap(~sampn)
ggsave("plots/momi_confusion_rad50k10k_exp.pdf",device="pdf")

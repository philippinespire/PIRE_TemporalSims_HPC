...
def run_ts(i,c):
	...
	subprocess.check_output(["/home/br450/build/slim","-m","-d","Nhistoric=10000","-d","t0sampfile='"+t0F+"'","-d","t30sampfile='"+t30F+"'","-d","t60sampfile='"+t60F+"'","-d","t90sampfile='"+t90F+"'","-d","t120sampfile='"+t120F+"'","-d","matingfile='"+MOF+"'","-d","deathfile='"+DOF+"'","-d","treeseqfile='"+TSOF+"'","-d","generationfile='"+GOF+"'",slim_template])

...
def momi_inference(it,dat,maf):
	...
	estimate=outdir+ sim + "_" + str(dat) + "_bot_estimates_4mods.csv"
	f = open(estimate,"a")
...
its=list(range(1,6))*6
its.sort()
dats=["n50_rad10k","n50_rad50k","n100_rad10k","n100_rad50k","n200_rad10k","n200_rad50k"]*5
mafs=["nomaf"]*30

...
outname="g1_n10e4_constant_n500_test/"
...
def make_filteredvcfs(i,c):
	...
	vcffilter14=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_c_nomaf"
	vcffilter15=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n200_c_maf1"
	vcffilter16=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n500_c_maf1"
	vcffilter17=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n200_c_maf1"
	...
	vcffilter20=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n500_c_nomaf"
	vcffilter21=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n200_c_nomaf"

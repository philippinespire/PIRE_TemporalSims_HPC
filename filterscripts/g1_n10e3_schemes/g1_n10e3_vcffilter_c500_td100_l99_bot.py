...
outname="g1_n10e3_td100_l99_n500/"
...
def make_filteredvcfs_contemp(i,c):
	...
	vcffilter14=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_contemp_nomaf"
...
def make_filteredvcfs_2samp(i,c):
	...
	vcffilter14=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_2samp_nomaf"
...
def make_filteredvcfs_serial(i,c):
	...
	vcffilter14=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_serial_nomaf"

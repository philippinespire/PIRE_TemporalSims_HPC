...
simdir="/scratch/br450/SLiM_ped_g10/"
simname="g10_n10e3_constant/"

outdir="/projects/f_mlp195/brendanr/"
outname="g10_n10e3_constant_n500/"
...
def make_filteredvcfs_contemp(i,c):
	...
	vcffilter14=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_contemp_nomaf1"
...
def make_filteredvcfs_2samp(i,c):
	...
	vcffilter14=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_2samp_nomaf1"
...
def make_filteredvcfs_serial(i,c):
	...
	vcffilter14=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_serial_nomaf1"

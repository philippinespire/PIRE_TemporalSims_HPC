...
outname="g1_n10e3_constant_n500/"
...
def make_bedfiles(it,c):
	...
	bedfile10k = simdir+simname+"i"+str(it)+"_chr_"+str(c)+"_bed10k_bot.bed"
	...
	while i < 2000:
		...
		i+=1
	bedlistsort=sorted(bedlist, key=lambda x: int(x[1]))
	bedfile50k = simdir+simname+"i"+str(it)+"_chr_"+str(c)+"_bed50k_bot.bed"
...
def make_filteredvcfs_contemp(i,c):
	vcfgzip=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_mu1.vcf.gz"
	vcfunzip=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_mu1.vcf"
	...
	bedfile10k = simdir+simname+"i"+str(i)+"_chr_"+str(c)+"_bed10k_bot.bed"
	bedfile50k = simdir+simname+"i"+str(i)+"_chr_"+str(c)+"_bed50k_bot.bed"
	substitute='s/^1\t/'+str(c)+'\t/g'
	vcffilter1=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n20_contemp_maf1"
	vcffilter2=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n50_contemp_maf1"
	vcffilter3=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n50_contemp_maf1"
	vcffilter4=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n100_contemp_maf1"
	vcffilter5=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n50_contemp_maf1"
	vcffilter6=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n100_contemp_maf1"
	vcffilter7=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n20_contemp_nomaf"
	vcffilter8=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n50_contemp_nomaf"
	vcffilter9=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n50_contemp_nomaf"
	vcffilter10=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n100_contemp_nomaf"
	vcffilter11=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n50_contemp_nomaf"
	vcffilter12=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n100_contemp_nomaf"
	vcffilter13=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_contemp_maf1"
	vcffilter14=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_contemp_nomaf1"
	vcffilter15=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n200_contemp_maf1"
	vcffilter16=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n500_contemp_maf1"
	vcffilter17=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n200_contemp_maf1"
	vcffilter18=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n500_contemp_maf1"
	vcffilter19=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n200_contemp_nomaf"
	vcffilter20=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n500_contemp_nomaf"
	vcffilter21=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n200_contemp_nomaf"
	vcffilter22=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n500_contemp_nomaf"
...
def make_filteredvcfs_2samp(i,c):
	...
	bedfile10k = simdir+simname+"i"+str(i)+"_chr_"+str(c)+"_bed10k_bot.bed"
	bedfile50k = simdir+simname+"i"+str(i)+"_chr_"+str(c)+"_bed50k_bot.bed"
	vcffilter1=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n20_2samp_maf1"
	vcffilter2=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n50_2samp_maf1"
	vcffilter3=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n50_2samp_maf1"
	vcffilter4=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n100_2samp_maf1"
	vcffilter5=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n50_2samp_maf1"
	vcffilter6=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n100_2samp_maf1"
	vcffilter7=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n20_2samp_nomaf"
	vcffilter8=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n50_2samp_nomaf"
	vcffilter9=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n50_2samp_nomaf"
	vcffilter10=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n100_2samp_nomaf"
	vcffilter11=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n50_2samp_nomaf"
	vcffilter12=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n100_2samp_nomaf"
	vcffilter13=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_2samp_maf1"
	vcffilter14=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_2samp_nomaf1"
	vcffilter15=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n200_2samp_maf1"
	vcffilter16=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n500_2samp_maf1"
	vcffilter17=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n200_2samp_maf1"
	vcffilter18=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n500_2samp_maf1"
	vcffilter19=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n200_2samp_nomaf"
	vcffilter20=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n500_2samp_nomaf"
	vcffilter21=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n200_2samp_nomaf"
	vcffilter22=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n500_2samp_nomaf"
	subprocess.run(["vcftools", "--vcf", str(vcfunzip), "--maf", "0.01", "--keep", str(indfile20), "--recode", "--out",str(vcffilter1)])
	subprocess.run(["bgzip", str(vcffilter1)+".recode.vcf"])
	subprocess.run(["tabix", "-p", "vcf", str(vcffilter1)+".recode.vcf.gz"])
	subprocess.run(["vcftools", "--vcf", str(vcfunzip), "--maf", "0.01", "--keep", str(indfile50), "--recode", "--out",str(vcffilter2)])
...
def make_filteredvcfs_serial(i,c):
	...
	bedfile10k = simdir+simname+"i"+str(i)+"_chr_"+str(c)+"_bed10k_bot.bed"
	bedfile50k = simdir+simname+"i"+str(i)+"_chr_"+str(c)+"_bed50k_bot.bed"
	vcffilter1=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n20_serial_maf1"
	vcffilter2=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n50_serial_maf1"
	vcffilter3=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n50_serial_maf1"
	vcffilter4=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n100_serial_maf1"
	vcffilter5=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n50_serial_maf1"
	vcffilter6=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n100_serial_maf1"
	vcffilter7=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n20_serial_nomaf"
	vcffilter8=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n50_serial_nomaf"
	vcffilter9=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n50_serial_nomaf"
	vcffilter10=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n100_serial_nomaf"
	vcffilter11=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n50_serial_nomaf"
	vcffilter12=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n100_serial_nomaf"
	vcffilter13=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_serial_maf1"
	vcffilter14=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_serial_nomaf1"
	vcffilter15=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n200_serial_maf1"
	vcffilter16=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n500_serial_maf1"
	vcffilter17=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n200_serial_maf1"
	vcffilter18=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n500_serial_maf1"
	vcffilter19=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n200_serial_nomaf"
	vcffilter20=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n500_serial_nomaf"
	vcffilter21=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n200_serial_nomaf"
	vcffilter22=outdir+outname+"bottleneck_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n500_serial_nomaf"
	subprocess.run(["vcftools", "--vcf", str(vcfunzip), "--maf", "0.01", "--keep", str(indfile20), "--recode", "--out",str(vcffilter1)])
	subprocess.run(["bgzip", str(vcffilter1)+".recode.vcf"])
	subprocess.run(["tabix", "-p", "vcf", str(vcffilter1)+".recode.vcf.gz"])
	subprocess.run(["vcftools", "--vcf", str(vcfunzip), "--maf", "0.01", "--keep", str(indfile50), "--recode", "--out",str(vcffilter2)])

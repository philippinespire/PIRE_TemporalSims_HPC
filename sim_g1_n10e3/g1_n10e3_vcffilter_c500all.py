...
def make_indfiles(i):
	...
	n500t0120file=simdir+simname+"i"+str(i)+"_n500t0120.txt"
	n200t0120file=simdir+simname+"i"+str(i)+"_n200t0120.txt"
	n100t0120file=simdir+simname+"i"+str(i)+"_n100t0120.txt"
	n50t0120file=simdir+simname+"i"+str(i)+"_n50t0120.txt"
	n20t0120file=simdir+simname+"i"+str(i)+"_n20t0120.txt"
	...
	with open(n500t0120file, "w") as indfile1:
		indfile1.writelines("\n".join(t0inds) + "\n")
		indfile1.writelines("\n".join(t30inds) + "\n")
		indfile1.writelines("\n".join(t60inds) + "\n")
		indfile1.writelines("\n".join(t90inds) + "\n")
		indfile1.writelines("\n".join(t120inds) + "\n")
	with open(n200t0120file, "w") as indfile1:
		indfile1.writelines("\n".join(t0inds[0:200]) + "\n")
		indfile1.writelines("\n".join(t30inds[0:40]) + "\n")
		indfile1.writelines("\n".join(t60inds[0:40]) + "\n")
		indfile1.writelines("\n".join(t90inds[0:40]) + "\n")
	...
	with open(n100t0120file, "w") as indfile1:
		...
		indfile1.writelines("\n".join(t90inds[0:20]) + "\n")
		indfile1.writelines("\n".join(t120inds[0:50]) + "\n")
	with open(n50t0120file, "w") as indfile2:
		indfile2.writelines("\n".join(t0inds[0:50]) + "\n")
		indfile2.writelines("\n".join(t30inds[0:10]) + "\n")
		indfile2.writelines("\n".join(t60inds[0:10]) + "\n")
		indfile2.writelines("\n".join(t90inds[0:10]) + "\n")
		indfile2.writelines("\n".join(t120inds[0:25]) + "\n")
	with open(n20t0120file, "w") as indfile3:
		indfile3.writelines("\n".join(t0inds[0:20]) + "\n")
		indfile3.writelines("\n".join(t30inds[0:4]) + "\n")
		indfile3.writelines("\n".join(t60inds[0:4]) + "\n")
		indfile3.writelines("\n".join(t90inds[0:4]) + "\n")
...
def make_filteredvcfs(i,c):
	...
	indfile20=simdir+simname+"i"+str(i)+"_n20t0120.txt"
	indfile50=simdir+simname+"i"+str(i)+"_n50t0120.txt"
	indfile100=simdir+simname+"i"+str(i)+"_n100t0120.txt"
	indfile200=simdir+simname+"i"+str(i)+"_n200t0120.txt"
	...
	vcffilter1=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n20_c_maf1"
	vcffilter2=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n50_c_maf1"
	vcffilter3=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n50_c_maf1"
	vcffilter4=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n100_c_maf1"
	vcffilter5=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n50_c_maf1"
	vcffilter6=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n100_c_maf1"
	vcffilter7=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n20_c_nomaf"
	vcffilter8=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n50_c_nomaf"
	vcffilter9=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n50_c_nomaf"
	vcffilter10=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n100_c_nomaf"
	vcffilter11=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n50_c_nomaf"
	vcffilter12=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n100_c_nomaf"
	vcffilter13=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_c_maf1"
	vcffilter14=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_wgs_n100_c_nomaf1"
	vcffilter15=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n200_c_maf1"
	vcffilter16=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n200_c_maf1"
	vcffilter17=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n500_c_maf1"
	vcffilter18=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n500_c_maf1"
	vcffilter19=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n200_c_nomaf"
	vcffilter20=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n200_c_nomaf"
	vcffilter21=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad10k_n500_c_nomaf"
	vcffilter22=outdir+outname+"constant_recap/vcf/i"+str(i)+"_chr_"+str(c)+"_rad50k_n500_c_nomaf"
	...
	subprocess.run(["vcftools", "--vcf", str(vcfunzip), "--maf", "0.01","--bed", str(bedfile10k), "--recode","--out", str(vcffilter16)])
	...
	subprocess.run(["vcftools", "--vcf", str(vcfunzip), "--maf", "0.01", "--bed", str(bedfile50k), "--recode","--out", str(vcffilter18)])
	...
	subprocess.run(["vcftools", "--vcf", str(vcfunzip), "--bed", str(bedfile10k), "--recode","--out", str(vcffilter20)])
	...
	subprocess.run(["vcftools", "--vcf", str(vcfunzip),  "--bed", str(bedfile50k), "--recode","--out", str(vcffilter22)])
...
outdir="/projects/f_mlp195/brendanr/"
outname="g1_n10e3_td100_l95_n500/"
...
outdir="/projects/f_mlp195/brendanr/"
outname="g1_n10e3_td130_l99_n500/"
...
outdir="/projects/f_mlp195/brendanr/"
outname="g1_n10e3_td130_l95_n500/"
...
outdir="/projects/f_mlp195/brendanr/"
outname="g1_n10e3_td160_l95_n500/"

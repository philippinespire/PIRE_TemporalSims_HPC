...
def make_vcf(i,c):
	...
	mut_ts = pyslim.load(mut_tsname)
	vcffile=dir+simname+"bottleneck_recap/vcf/"+"i"+str(i)+"_chr_"+str(c)+"_mu"+str(int(murate*10e7))+".vcf"
	zipfile=dir+simname+"bottleneck_recap/vcf/"+"i"+str(i)+"_chr_"+str(c)+"_mu"+str(int(murate*10e7))+".vcf.gz"
	os.makedirs(dir+simname+"bottleneck_recap/vcf/",exist_ok=True)
	...
	mut_ts = pyslim.load(mut_tsname)
	vcffile=dir+simname+"expansion_recap/vcf/"+"i"+str(i)+"_chr_"+str(c)+"_mu"+str(int(murate*10e7))+".vcf"
	zipfile=dir+simname+"expansion_recap/vcf/"+"i"+str(i)+"_chr_"+str(c)+"_mu"+str(int(murate*10e7))+".vcf.gz"
	os.makedirs(dir+simname+"expansion_recap/vcf/",exist_ok=True)

...
while [ $it -le 5 ]
do
	mkdir -p ${simdir}${data}_i${it}/stairway_exp
	cp ${dir}${sim}expansion_recap/vcf/i${it}_allchr_${data}_${lgm}_${maf}_t0.recode.vcf ${simdir}${data}_i${it}/stairway_exp
	cp -r /home/br450/stairway-plot-v2/stairway_plot_v2.1.1/stairway_plot_es ${simdir}${data}_i${it}/stairway_exp
	cp /home/br450/stairway-plot-v2/stairway_plot_v2.1.1/two-epoch_fold.blueprint ${simdir}${data}_i${it}/stairway_exp
	cp /home/br450/indpopmap20 ${simdir}${data}_i${it}/stairway_exp
	cp /home/br450/vcf2sfs/getvcf_template_exp.R ${simdir}${data}_i${it}/stairway_exp/getvcf_i${it}_${data}_${maf}.R
	cd ${simdir}${data}_i${it}/stairway_exp
...
do
	...
	cp -r /home/br450/stairway-plot-v2/stairway_plot_v2.1.1/stairway_plot_es ${simdir}${data}_i${it}/stairway_exp
	cp /home/br450/stairway-plot-v2/stairway_plot_v2.1.1/two-epoch_fold.blueprint ${simdir}${data}_i${it}/stairway_exp
	cp /home/br450/indpopmap50 ${simdir}${data}_i${it}/stairway_exp
	cp /home/br450/vcf2sfs/getvcf_template_exp.R ${simdir}${data}_i${it}/stairway_exp/getvcf_i${it}_${data}_${maf}.R
	cd ${simdir}${data}_i${it}/stairway_exp
	sed -i "s/_iteration/${it}/g" getvcf_i${it}_${data}_${maf}.R
	sed -i "s/_numsamp/${sampn}/g" getvcf_i${it}_${data}_${maf}.R
...
do
	...
	cp -r /home/br450/stairway-plot-v2/stairway_plot_v2.1.1/stairway_plot_es ${simdir}${data}_i${it}/stairway_exp
	cp /home/br450/stairway-plot-v2/stairway_plot_v2.1.1/two-epoch_fold.blueprint ${simdir}${data}_i${it}/stairway_exp
	cp /home/br450/indpopmap100 ${simdir}${data}_i${it}/stairway_exp
	cp /home/br450/vcf2sfs/getvcf_template_exp.R ${simdir}${data}_i${it}/stairway_exp/getvcf_i${it}_${data}_${maf}.R
	cd ${simdir}${data}_i${it}/stairway_exp
	sed -i "s/_iteration/${it}/g" getvcf_i${it}_${data}_${maf}.R
	sed -i "s/_numsamp/${sampn}/g" getvcf_i${it}_${data}_${maf}.R

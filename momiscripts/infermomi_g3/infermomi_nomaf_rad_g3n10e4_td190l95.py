...
def momi_inference(it,dat,maf):
	...
	model_inf_cons_t0 =  momi.DemographicModel(N_e=1e3, gen_time=3, muts_per_gen=1e-8)
	#add data to model
	...
	model_inf_dec_t0 =  momi.DemographicModel(N_e=1e3, gen_time=3, muts_per_gen=1e-8)
	#add data to model
	...
	model_inf_cons_t0t120 =  momi.DemographicModel(N_e=1e3, gen_time=3, muts_per_gen=1e-8)
	#add data to model
	...
	model_inf_dec_t0t120 =  momi.DemographicModel(N_e=1e3, gen_time=3, muts_per_gen=1e-8)
	#add data to model
	...
	model_inf_cons_all =  momi.DemographicModel(N_e=1e3, gen_time=3, muts_per_gen=1e-8)
	#add data to model
	...
	model_inf_dec_all =  momi.DemographicModel(N_e=1e3, gen_time=3, muts_per_gen=1e-8)
	#add data to model
	...
	estimate=outdir+ sim + "_" + str(dat) + "_estimates.csv"
	f = open(estimate,"a")
...
its.sort()
dats=["n50_rad10k","n50_rad50k","n100_rad10k","n100_rad50k"]*5
mafs=["nomaf"]*20

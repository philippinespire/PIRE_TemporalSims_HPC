...
sim = "g1_n10e3_constant_n500_test"

def momi_inference(it,dat):
	datadir = dir + sim + "/constant_recap/vcf/"
	# read sfs into python!
	sfsfile= datadir + "i" + str(it) + "_" + str(dat) + ".sfs.gz"
...
its=list(range(1,6))*8
its.sort()
dats=["n50_rad10k_maf1","n50_rad50k_maf1","n100_rad10k_maf1","n100_rad50k_maf1","n200_rad10k_maf1","n200_rad50k_maf1","n500_rad10k_maf1","n500_rad50k_maf1"]*5
result = a_pool.starmap(momi_inference, zip(its,dats))
